...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#007aff' : PRIMARY_COLOR,
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : PRIMARY_COLOR,
  ...
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : PRIMARY_COLOR,

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : PRIMARY_COLOR,
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : PRIMARY_COLOR,
  ...
  listItemSelected: platform === PLATFORM.IOS ? '#007aff' : PRIMARY_COLOR,
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? '#F8F8F8' : PRIMARY_COLOR,
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : PRIMARY_COLOR,
  segmentBorderColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : PRIMARY_COLOR,
  ...
  tabDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : PRIMARY_COLOR,
